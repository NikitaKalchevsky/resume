...
*Последнее обновление: 2026-07-02 — полная смена дизайна на тему Organic: многофайловый статик (index.html + styles.css + main.js + scene.js), 3D-hero three.js «MK», 7 проектов (флагман Exclusive Style с реальным скрином exclusivestyle-home.jpg, он же в og/twitter), i18n на 4 языка через data-i18n. Старый дизайн сохранён как index.legacy.html. PDF-хук переписан на http-рендер. Открывать локально только через http (Live Server / npx serve), не через file://. Осталось: живые переводы UK/ES.*
