...
(function () {
  ...
  var T = {
    uk: {
      ...
      'edu.focus': 'Зараз заглиблююсь у', 'edu.note': 'Самонавчання. Вчуся, запускаючи продакшн-системи, потім їх зміцнюю і беруся за наступну складну задачу.',
    ...
    ru: {
      ...
      'edu.focus': 'Сейчас углубляюсь в', 'edu.note': 'Самообучение. Учусь, запуская продакшн-системы, потом их укрепляю и берусь за следующую сложную задачу.',
    ...
    es: {
      ...
      'edu.focus': 'Ahora profundizando en', 'edu.note': 'Autodidacta. Aprendo lanzando sistemas en producción, luego los endurezco y paso al siguiente problema difícil.',
